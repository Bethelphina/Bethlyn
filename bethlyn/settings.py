"""
Django settings for bethlyn project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'carts.cart_context_processors.counter',
            ],
        },
    },
]

WSGI_APPLICATION = 'bethlyn.wsgi.application'
...
PAYSTACK_TEST_SECRET_KEY ="dfsdf"#config("PAYSTACK_TEST_SECRET_KEY")
PAYSTACK_TEST_PUBLIC_KEY ="sdfdf"#config("PAYSTACK_TEST_PUBLIC_KEY")
