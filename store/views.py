...
def productdetail(request, category_slug, product_slug):
    ...
    # checking if user has purchase product before we can let them review.
    if request.user.is_authenticated:
        try:
            orderedproduct = OrderProduct.objects.filter(
...
def submit_review(request, product_id):
    print("Proudci being sent a reveiw is:",product_id)
